...
const CardContainer: React.FC<CardContainerProps> = ({ children, className = '', containerClassName = '' }) => (
...
const CardItem: React.FC<CardItemProps> = ({ children, className = '', as: Component = 'div', ...props }) => (
            ...
            return (
              ...
              >
                <CardContainer className="inter-var" containerClassName="py-0">
                  ...
                  >
                    <CardBody 
                      className="bg-slate-800/90 relative group/card hover:shadow-2xl hover:shadow-[#6AAEFF]/[0.1] border-slate-700/50 w-80 rounded-xl border backdrop-blur-sm overflow-visible flex flex-col"
                    >
